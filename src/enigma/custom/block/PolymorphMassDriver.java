...
public class PolymorphMassDriver extends MassDriver {
	...
	public class PolymorphRadarBuild extends MassDriverBuild implements PolymorphUtilizer, PolymorphConsumer {
		...
		public float getConsumed(PolymorphPowerType type) {
			return consumed.quantity * ((state != DriverState.idle) ? 1 : 0);
		}
