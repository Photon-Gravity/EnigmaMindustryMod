...
public class ShadedConduit extends Conduit {
	...
	public TextureRegion[] icons() {
		return new TextureRegion[]{botRegions[0], overlay[0][0]};
	}

	public class ShadedConveyorBuild extends ConduitBuild {
		@Override
		public void draw() {
			super.draw();

			boolean rotateCorner = blendbits == 1 && (xscl * yscl == -1);
			boolean rotateYMerge = blendbits == 2 && (xscl * yscl == -1);
			boolean rotateTMerge = blendbits == 4;
